...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UsoInsumos.unidad'
        db.alter_column(u'produccion_cafe_finca_usoinsumos', 'unidad', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'UsoInsumos.unidad'
        db.alter_column(u'produccion_cafe_finca_usoinsumos', 'unidad', self.gf('django.db.models.fields.IntegerField')(default=None))
